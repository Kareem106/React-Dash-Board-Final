...
function SideBar() {
  ...
  return (
    <header className='fixed sm:static top-0 left-0 z-40 w-64'>
<button type="button" onClick={()=>{setCollapse(!collapse)}} className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<aside className={`h-screen transition-transform -translate-x-${collapse?"full":"0"} sm:translate-x-0`} >
